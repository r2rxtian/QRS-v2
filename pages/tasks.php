...
<body>
    ...
    <!-- Stat Tiles -->
    <div class="stat-tiles" data-realtime-region="task-stats">
        <div class="stat-tile">
        ...
        <div class="card-header">
            ...
            <div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
                ...
                <div class="form-group">
                    <label for="tasksEntries" class="form-label">Show</label>
                    <select id="tasksEntries" class="form-input" onchange="onTasksEntriesChange(this.value)">
    ...
    <div id="createTaskModal" class="modal-overlay">
        <div class="modal modal-split">
            ...
            <div class="modal-body modal-body-split">
                ...
                <div class="modal-body-right" id="taskLocationsPanel" data-realtime-region="task-location-picker">
                    <div class="modal-panel-header">
    ...
    <script src="../scripts/tasks.js?v=8"></script>
</body>
