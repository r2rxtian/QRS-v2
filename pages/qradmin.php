...
$sql = '
    ...
    GROUP BY t.id, t.name, t.created_at, u.employee_id, uml.LastName, uml.FirstName, uml.MiddleName, u.avatar_initials, u.avatar_color
    ORDER BY t.id DESC';
                ...
                <div class="filter-wrap" data-table="allTasksTable">
                    ...
                    <div class="filter-panel">
                        ...
                        <div class="filter-group">
                            ...
                            <label class="filter-option"><input type="checkbox" data-filter="missed" value="Yes"> Has Missed Location</label>
                            <label class="filter-option"><input type="checkbox" data-filter="missed" value="No"> None Missed</label>
                        </div>
...
<script src="../scripts/qradmin.js?v=3"></script>
</body>
